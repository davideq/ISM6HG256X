/*
   @file    ISM6HG256X_DataLog_Terminal_I3C.ino
   @author  STMicroelectronics
   @brief   Example to use the ISM6HG256X sensor with I3C and SETDASA command
 *******************************************************************************
...
#define ISM6HG256X_DYNAMIC_ADDRESS 0x30
...
void setup()
{
  ...
  if (!I3C.assignDynamicAddress(sensor.getStaticAddress(), ISM6HG256X_DYNAMIC_ADDRESS)) {
    while (1) {}
  }
  if (sensor.begin(ISM6HG256X_DYNAMIC_ADDRESS) != ISM6HG256X_OK) {
    while (1) {}
  }
